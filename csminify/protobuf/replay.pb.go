...
type Replay_Tick_Event_Type int32

const (
	Replay_Tick_Event_JUMP          Replay_Tick_Event_Type = 0
	Replay_Tick_Event_FIRE          Replay_Tick_Event_Type = 1
	Replay_Tick_Event_HURT          Replay_Tick_Event_Type = 2
	Replay_Tick_Event_FLASHED       Replay_Tick_Event_Type = 3
	Replay_Tick_Event_KILL          Replay_Tick_Event_Type = 4
	Replay_Tick_Event_ROUND_STARTED Replay_Tick_Event_Type = 5
	Replay_Tick_Event_SWAP_TEAM     Replay_Tick_Event_Type = 6
	Replay_Tick_Event_DISCONNECT    Replay_Tick_Event_Type = 7
)

var Replay_Tick_Event_Type_name = map[int32]string{
	0: "JUMP",
	1: "FIRE",
	2: "HURT",
	3: "FLASHED",
...
var Replay_Tick_Event_Type_value = map[string]int32{
	"JUMP":          0,
	"FIRE":          1,
	"HURT":          2,
	"FLASHED":       3,
...
func (x Replay_Tick_Event_Type) String() string {
	return proto.EnumName(Replay_Tick_Event_Type_name, int32(x))
}
func (Replay_Tick_Event_Type) EnumDescriptor() ([]byte, []int) {
...
type Replay_Tick_Event struct {
	Type       Replay_Tick_Event_Type         `protobuf:"varint,1,opt,name=type,proto3,enum=protobuf.Replay_Tick_Event_Type" json:"type,omitempty"`
...
func (m *Replay_Tick_Event) GetType() Replay_Tick_Event_Type {
	if m != nil {
		return m.Type
	}
...
type Replay_Tick_Event_Attribute struct {
	Kind        Replay_Tick_Event_Attribute_Kind `protobuf:"varint,1,opt,name=kind,proto3,enum=protobuf.Replay_Tick_Event_Attribute_Kind" json:"kind,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("protobuf.Replay_Tick_Event_Type", Replay_Tick_Event_Type_name, Replay_Tick_Event_Type_value)
	proto.RegisterEnum("protobuf.Replay_Tick_Event_Attribute_Kind", Replay_Tick_Event_Attribute_Kind_name, Replay_Tick_Event_Attribute_Kind_value)
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (Replay_Tick_Event_Type(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorReplay = []byte{
	...
	,
}
